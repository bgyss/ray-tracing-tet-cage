...
| 9 — scale and method selection | partially proven | direct synthetic Metal sweep and CPU benchmark retain negative results; measured-input selector and fallback artifact are in `results/selection/2026-07-28-two-tet-policy.json`; cross-platform crossover remains open |
...
| 14 — production hardening | partially proven | portable CI, fuzz/malformed checks, v1 golden/migration, deterministic report, and policy fallbacks exist; historical migration, shader/device conformance, sample release, device loss/reset, retained backends, and renderer gates remain |
