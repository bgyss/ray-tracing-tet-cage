...
transport contract (`$CYCLES_NATIVE_WORKTREE`, revision `eff24a310256`, based on
...
normal/position/UV/source-normal and source material-slot handoff and point/sun lighting controls match, while area-light
...
Blender branch (`0e320b809962`) compiles
...
| Blender source | `$BLENDER_SOURCE_ROOT` at `4a09c19bea7bd2800d85f018280b2dc62e654e51` (2026-08-09), clean when inspected. The isolated candidate branch at `0e320b809962c8ed6a3b1bb7b27c14c729bb5423` compiles and verifies opt-in static, object-transform-motion, and native shape-key deformation tet-cage dispatch without changing the source checkout. |
