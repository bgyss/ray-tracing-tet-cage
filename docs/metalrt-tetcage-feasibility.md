...
transport contract (`$CYCLES_NATIVE_WORKTREE`, revision `68ecd6550c6d`, based on
...
dispatch remain unproven. An isolated Blender branch (`d3da8bef39b4`) compiles
...
native-vs-fallback emission differentials. Static local scanning and shadow
callback seams compile in both native lanes. Its full Blender target, app-bundle
...
| Blender source | `$BLENDER_SOURCE_ROOT` at `4a09c19bea7bd2800d85f018280b2dc62e654e51` (2026-08-09), clean when inspected. The isolated candidate branch at `d3da8bef39b46e22a590656ef5203353a611951d` compiles and verifies opt-in static native tet-cage dispatch without changing the source checkout. |
