...
transport contract (`$CYCLES_NATIVE_WORKTREE`, revision `20a72619765e`, based on
...
Blender branch (`9f1267111935`) compiles
...
ordinary mesh fallback. Static local scanning now uses the same projected-axis narrow phase and Cycles hit-record policy as camera/shadow rays; shadow callback seams compile
...
| Blender source | `$BLENDER_SOURCE_ROOT` at `4a09c19bea7bd2800d85f018280b2dc62e654e51` (2026-08-09), clean when inspected. The isolated candidate branch at `9f1267111935b86b349c52b223862a7047913e0b` compiles and verifies opt-in static plus object-transform-motion native tet-cage dispatch without changing the source checkout. |
