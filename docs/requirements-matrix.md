...
| Cycles | canonical loader, MetalRT and OptiX device integration | pinned source build and same-scene device comparison | prepared: standalone Cycles `97dbe6f57cdf4ede2d2b75ebdda507c8712edb7a` builds and passes its upstream CPU test against pinned macOS dependencies; clean Blender `4a09c19bea7bd2800d85f018280b2dc62e654e51` configures a developer/debug UI build and compiles `bf_intern_cycles`; M9 and NVIDIA/OptiX remain device gates |
