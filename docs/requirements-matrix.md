...
| Metal fast backend | immutable micro-BLAS, GPU transforms/descriptors, TLAS, tracing | M5 correctness and scale sweep | measured partial: four-asset corpus, eight-frame dense animation, six TLAS refits, one rebuild, zero dense CPU mesh regenerations, and standard/extended 65,536-instance builds are direct; fallback restores final correctness but its 78.1% corpus frequency and pending replay minimization keep M5 open |
