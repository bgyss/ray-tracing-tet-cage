...
| Hit provenance | source primitive/material plus source barycentrics | position, UV, normal, material and custom-attribute differential | position, normal, UV, source normal corner attribute, and source material-slot IDs implemented and probed; full renderer material/custom-attribute parity pending |
