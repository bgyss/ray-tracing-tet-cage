...
revision `8517d22ce108` (based on `1059d3e590045c008cb69e8e82c2b97554278c77`). Its
...
Blender sync. The isolated Blender branch at `882b1483dcc6` now recognizes that
